...
void TriangleEffect::Element::Draw(const Vec4f& color) {
	...
	resource_->transformationMatrixData_->World = worldTransform_.worldMatrix;
	resource_->transformationMatrixData_->WVP = worldTransform_.worldMatrix * Engine::GetCamera()->GetVpMatrix();
